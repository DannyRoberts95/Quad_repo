class Element_Distortion extends PApplet {
  ...
  public Element_Distortion(int sn ) {
    super();
  ...
  class ElementDistortEffect {
    float tx, ty;
    int hOffset = 0;
    PImage capture = kinect.rgbImage();
    int w = capture.width;
    ...
    void horizontalSlitGlitch() {
      int glitchNum = int( distortionValue/100);
    ...
    void boxArtefacts() {
      ...
      for (int i=0; i<glitchValue / 15; i++) {
